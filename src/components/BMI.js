                ...
                <div className="row px-lg-3 align-items-center mt-5">
                    <div className="col-md-6">
                        <div className="pe-md-3 d-none d-md-block">
                            ...
                            <p className="m-0 text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas quis magna elit. In pulvinar id neque non condimentum. Aenean tempus accumsan lacus vitae laoreet. </p>
                        </div>
                    </div>
                            ...
                            <form>
                                <div className="row">
                                    <div className="col-sm mb-sm-0 mb-4">
                                        <input type="text" className="form-control bg-light rounded-0" value={weight} onChange={WeightVal} placeholder="Weight (KG)" />
                                    </div>
                                    <div className="col">
                                        <input type="text" className="form-control bg-light  rounded-0" value={height} onChange={HeightVal} placeholder="Height (CM)" />
                                    </div>
                                </div>
                                <div className="row mt-4">
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control bg-light  rounded-0" value={myStyle} placeholder="BMI" />
                                    </div>
                                </div>
                            </form>
                        </div>
